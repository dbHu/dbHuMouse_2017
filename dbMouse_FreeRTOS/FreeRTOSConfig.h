...
#define configKERNEL_INTERRUPT_PRIORITY         ( 24 << 5 )    /* Priority 7, or 0xE0 as only the top three bits are implemented.  This is the lowest priority. */
#define configMAX_SYSCALL_INTERRUPT_PRIORITY     ( 16 << 5 )  /* Priority 5, or 0xA0 as only the top three bits are implemented. */
